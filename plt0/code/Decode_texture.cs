...
class Decode_texture_class
{
    ...
    public void Decode_texture(string input_file, string palette_file, string output_file, byte[] real_block_width_array, byte[] block_width_array, byte[] block_height_array, bool tex0, bool tpl, byte[] colour_palette, byte palette_format3, bool bmp_32, bool funky, bool reverse, bool warn, bool stfu, bool no_warning, bool safe_mode, bool png, bool gif, bool jpeg, bool jpg, bool ico, bool tiff, bool tif, byte mipmaps_number)
    {
        ...
        object picture = f.Fill_index_list(data, data_start_offset, texture_format_int32[3], mipmaps_number, real_block_width_array, block_width_array, block_height_array, reverse);
