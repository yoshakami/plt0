                ...
                case 32:  // 32-bit BGRA bmp image
                    {
                        ...
                        for (int i = 0; i < colour_number; i++)
                        {
                            ...
                            for (int k = 0; k < j; k += 2)
                            {
                                if (Math.Abs(colour_palette[k] - (byte)(Colour_Table[i][1] >> 8)) < diversity || Math.Abs(colour_palette[k] - (byte)(Colour_Table[i][1])) < diversity)
                                {
                                    not_similar = false;
                                    break;
                                }
