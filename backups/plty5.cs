        ...
        public void parse_args()
        {
            ...
            for (ushort i = 1; i < args.Length; i++)
            {
                ...
                switch (args[i].ToUpper())
                {
                    ...
                    case "ROUND4":
                        {
                            byte.TryParse(args[i + 1], out round4);
                            pass = 1;
                            if (round4 > 15)
                            {
                    ...
                    case "ROUND5":
                        {
                            byte.TryParse(args[i + 1], out round5);
                            pass = 1;
                            if (round5 > 7)
                            {
                    ...
                    case "ROUND6":
                        {
                            byte.TryParse(args[i + 1], out round6);
                            pass = 1;
                            if (round6 > 3)
                            {
                    ...
                    case 6: // RGBA32
                        {
                            ...
                            */
                            switch (algorithm)
                            {
                                case 2:  // custom
                                    {
                                        for (int i = pixel_data_start_offset; i < bmp_filesize; i += 16)
                                        {
                                            ...
                                            index[j + 8] = (byte)(bmp_image[i + 19] * custom_rgba[3]);  // A
                                            index[j + 9] = (byte)(bmp_image[i + 18] * custom_rgba[0]);  // R
                                            index[j + 10] = (byte)(bmp_image[i + 23] * custom_rgba[3]); // A
                                            index[j + 11] = (byte)(bmp_image[i + 22] * custom_rgba[0]); // R
                                            index[j + 12] = (byte)(bmp_image[i + 27] * custom_rgba[3]); // A
                                            index[j + 13] = (byte)(bmp_image[i + 26] * custom_rgba[0]); // R
                                            index[j + 14] = (byte)(bmp_image[i + 31] * custom_rgba[3]); // A
                                            index[j + 15] = (byte)(bmp_image[i + 30] * custom_rgba[0]); // R
                                            index[j + 16] = (byte)(bmp_image[i + 35] * custom_rgba[3]); // A
                                            index[j + 17] = (byte)(bmp_image[i + 34] * custom_rgba[0]); // R
                                            index[j + 18] = (byte)(bmp_image[i + 39] * custom_rgba[3]); // A
                                            index[j + 19] = (byte)(bmp_image[i + 38] * custom_rgba[0]); // R
                                            index[j + 20] = (byte)(bmp_image[i + 43] * custom_rgba[3]); // A
                                            index[j + 21] = (byte)(bmp_image[i + 42] * custom_rgba[0]); // R
                                            index[j + 22] = (byte)(bmp_image[i + 47] * custom_rgba[3]); // A
                                            index[j + 23] = (byte)(bmp_image[i + 46] * custom_rgba[0]); // R
                                            index[j + 24] = (byte)(bmp_image[i + 51] * custom_rgba[3]); // A
                                            index[j + 25] = (byte)(bmp_image[i + 50] * custom_rgba[0]); // R
                                            index[j + 26] = (byte)(bmp_image[i + 55] * custom_rgba[3]); // A
                                            index[j + 27] = (byte)(bmp_image[i + 54] * custom_rgba[0]); // R
                                            index[j + 28] = (byte)(bmp_image[i + 59] * custom_rgba[3]); // A
                                            index[j + 29] = (byte)(bmp_image[i + 58] * custom_rgba[0]); // R
                                            index[j + 30] = (byte)(bmp_image[i + 63] * custom_rgba[3]); // A
                                            index[j + 31] = (byte)(bmp_image[i + 62] * custom_rgba[0]); // R

                                            // Green and Blue
                                            index[j + 40] = (byte)(bmp_image[i + 17] * custom_rgba[1]); // G
                                            index[j + 41] = (byte)(bmp_image[i + 16] * custom_rgba[2]); // B
                                            index[j + 42] = (byte)(bmp_image[i + 21] * custom_rgba[1]); // G
                                            index[j + 43] = (byte)(bmp_image[i + 20] * custom_rgba[2]); // B
                                            index[j + 44] = (byte)(bmp_image[i + 25] * custom_rgba[1]); // G
                                            index[j + 45] = (byte)(bmp_image[i + 24] * custom_rgba[2]); // B
                                            index[j + 46] = (byte)(bmp_image[i + 29] * custom_rgba[1]); // G
                                            index[j + 47] = (byte)(bmp_image[i + 28] * custom_rgba[2]); // B
                                            index[j + 48] = (byte)(bmp_image[i + 33] * custom_rgba[1]); // G
                                            index[j + 49] = (byte)(bmp_image[i + 32] * custom_rgba[2]); // B
                                            index[j + 50] = (byte)(bmp_image[i + 37] * custom_rgba[1]); // G
                                            index[j + 51] = (byte)(bmp_image[i + 36] * custom_rgba[2]); // B
                                            index[j + 52] = (byte)(bmp_image[i + 41] * custom_rgba[1]); // G
                                            index[j + 53] = (byte)(bmp_image[i + 40] * custom_rgba[2]); // B
                                            index[j + 54] = (byte)(bmp_image[i + 45] * custom_rgba[1]); // G
                                            index[j + 55] = (byte)(bmp_image[i + 44] * custom_rgba[2]); // B
                                            index[j + 56] = (byte)(bmp_image[i + 49] * custom_rgba[1]); // G
                                            index[j + 57] = (byte)(bmp_image[i + 48] * custom_rgba[2]); // B
                                            index[j + 58] = (byte)(bmp_image[i + 53] * custom_rgba[1]); // G
                                            index[j + 59] = (byte)(bmp_image[i + 52] * custom_rgba[2]); // B
                                            index[j + 60] = (byte)(bmp_image[i + 57] * custom_rgba[1]); // G
                                            index[j + 61] = (byte)(bmp_image[i + 56] * custom_rgba[2]); // B
                                            index[j + 62] = (byte)(bmp_image[i + 61] * custom_rgba[1]); // G
                                            index[j + 63] = (byte)(bmp_image[i + 60] * custom_rgba[2]); // B
                                            j += 16;
                                            if (j == index.Length)
                                            {
                                                j = 0;
                                ...
                                default:
                                    {
                                        for (int i = pixel_data_start_offset; i < bmp_filesize; i += 64)
                                        {
                                            // alpha and red
                                            ...
                                            index[j + 8] = (byte)(bmp_image[i + 19]);  // A
                                            index[j + 9] = (byte)(bmp_image[i + 18]);  // R
                                            index[j + 10] = (byte)(bmp_image[i + 23]); // A
                                            index[j + 11] = (byte)(bmp_image[i + 22]); // R
                                            index[j + 12] = (byte)(bmp_image[i + 27]); // A
                                            index[j + 13] = (byte)(bmp_image[i + 26]); // R
                                            index[j + 14] = (byte)(bmp_image[i + 31]); // A
                                            index[j + 15] = (byte)(bmp_image[i + 30]); // R
                                            index[j + 16] = (byte)(bmp_image[i + 35]); // A
                                            index[j + 17] = (byte)(bmp_image[i + 34]); // R
                                            index[j + 18] = (byte)(bmp_image[i + 39]); // A
                                            index[j + 19] = (byte)(bmp_image[i + 38]); // R
                                            index[j + 20] = (byte)(bmp_image[i + 43]); // A
                                            index[j + 21] = (byte)(bmp_image[i + 42]); // R
                                            index[j + 22] = (byte)(bmp_image[i + 47]); // A
                                            index[j + 23] = (byte)(bmp_image[i + 46]); // R
                                            index[j + 24] = (byte)(bmp_image[i + 51]); // A
                                            index[j + 25] = (byte)(bmp_image[i + 50]); // R
                                            index[j + 26] = (byte)(bmp_image[i + 55]); // A
                                            index[j + 27] = (byte)(bmp_image[i + 54]); // R
                                            index[j + 28] = (byte)(bmp_image[i + 59]); // A
                                            index[j + 29] = (byte)(bmp_image[i + 58]); // R
                                            index[j + 30] = (byte)(bmp_image[i + 63]); // A
                                            index[j + 31] = (byte)(bmp_image[i + 62]); // R

                                            // Green and Blue
                                            index[j + 32] = (byte)(bmp_image[i + 1]);  // G
                                            index[j + 33] = (byte)(bmp_image[i]);      // B
                                            index[j + 34] = (byte)(bmp_image[i + 5]);  // G
                                            index[j + 35] = (byte)(bmp_image[i + 4]);  // B
                                            index[j + 36] = (byte)(bmp_image[i + 9]);  // G
                                            index[j + 37] = (byte)(bmp_image[i + 8]);  // B
                                            index[j + 38] = (byte)(bmp_image[i + 13]); // G
                                            index[j + 39] = (byte)(bmp_image[i + 12]); // B
                                            index[j + 40] = (byte)(bmp_image[i + 17]); // G
                                            index[j + 41] = (byte)(bmp_image[i + 16]); // B
                                            index[j + 42] = (byte)(bmp_image[i + 21]); // G
                                            index[j + 43] = (byte)(bmp_image[i + 20]); // B
                                            index[j + 44] = (byte)(bmp_image[i + 25]); // G
                                            index[j + 45] = (byte)(bmp_image[i + 24]); // B
                                            index[j + 46] = (byte)(bmp_image[i + 29]); // G
                                            index[j + 47] = (byte)(bmp_image[i + 28]); // B
                                            index[j + 48] = (byte)(bmp_image[i + 33]); // G
                                            index[j + 49] = (byte)(bmp_image[i + 32]); // B
                                            index[j + 50] = (byte)(bmp_image[i + 37]); // G
                                            index[j + 51] = (byte)(bmp_image[i + 36]); // B
                                            index[j + 52] = (byte)(bmp_image[i + 41]); // G
                                            index[j + 53] = (byte)(bmp_image[i + 40]); // B
                                            index[j + 54] = (byte)(bmp_image[i + 45]); // G
                                            index[j + 55] = (byte)(bmp_image[i + 44]); // B
                                            index[j + 56] = (byte)(bmp_image[i + 49]); // G
                                            index[j + 57] = (byte)(bmp_image[i + 48]); // B
                                            index[j + 58] = (byte)(bmp_image[i + 53]); // G
                                            index[j + 59] = (byte)(bmp_image[i + 52]); // B
                                            index[j + 60] = (byte)(bmp_image[i + 57]); // G
                                            index[j + 61] = (byte)(bmp_image[i + 56]); // B
                                            index[j + 62] = (byte)(bmp_image[i + 61]); // G
                                            index[j + 63] = (byte)(bmp_image[i + 60]); // B
                                            j += 64;
                                            if (j == index.Length)
                                            {
                                                j = 0;
