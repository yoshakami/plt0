...
namespace plt0
{
    ...
    class plt0_class
    {
        ...
        public void parse_args()
        {
            ...
            if (colour_number == 0)  // don't ask me why it's not minus one, but it's zero by default lol
            {
