                            ...
                            case 1:  // RGB565
                                {
                                    ...
                                    for (int i = 0; i < Colour_Table.Count && j < colour_number_x2; i++)
                                    {
                                        ...
                                        if (not_similar)
                                        {
                                            colour_palette[j] = (byte)(Colour_Table[i][1] >> 8);  // adds the 
                                            colour_palette[j + 1] = (byte)(Colour_Table[i][1]);  // RGB value
                                            j += 2;
                                        }
                                    }
                                    break;
                            ...
                            case 2:  // RGB5A3
                                {
                                    ...
                                    else  // 1RRR RRGG GGGB BBBB
                                    {
                                        for (int i = 0; i < Colour_Table.Count && j < colour_number_x2; i++)
                                        {
                                            ...
                                            if (not_similar)
                                            {
                                                colour_palette[j] = (byte)(Colour_Table[i][1] >> 8);  // adds the Red, 
                                                colour_palette[j + 1] = (byte)(Colour_Table[i][1]);  // Green, and Blue value
                                                j += 2;
                                            }
                                        }
                                    }
