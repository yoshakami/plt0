                                        ...
                                        case 2:  // custom
                                            {
                                                if (alpha == 1)  // 0AAA RRRR GGGG BBBB
                                                {
                                                    for (int i = pixel_data_start_offset; i < bmp_filesize; i += 4)
                                                    {
                                                        ...
                                                        pixel = (ushort)((((byte)(a) >> 5) << 12) + (((byte)(red) >> 4) << 8) + (((byte)(green) >> 4) << 4) + (byte)(blue) >> 4);
                                                        Colours.Add(pixel);
                                                        Colour_Table[pixel][0] += 1;
                                                    }
                                                }
                                                else if (alpha == 0)  // 1RRR RRGG GGGB BBBB
                                                {
                                                    for (int i = pixel_data_start_offset; i < bmp_filesize; i += 4)
                                                    {
                                                        ...
                                                        pixel = (ushort)((1 << 15) + (((byte)(red) >> 3) << 10) + (((byte)(green) >> 3) << 5) + (byte)(blue) >> 3);
                                                        Colours.Add(pixel);
                                                        Colour_Table[pixel][0] += 1;
                                                    }
                                                }
                                    ...
                                    if (alpha == 1)
                                    {
                                        ...
                                        if (j < colour_number_x2) // if the colour palette is not full
                                        {
                                            ...
                                            for (int i = 0; i < Colour_Table.Count && j < colour_number_x2; i++)
                                            {
                                                ...
                                                for (int k = 0; k < j; k += 2)
                                                {
                                                    if (Math.Abs((colour_palette[k] & 112) - (Colour_Table[i][1] >> 8) & 112) < diversity2 && Math.Abs(((colour_palette[k] << 4) & 240) - ((Colour_Table[i][1] >> 4) & 240)) < diversity2 && Math.Abs(colour_palette[k + 1] - ((Colour_Table[i][1]) & 240)) < diversity2 && Math.Abs(((colour_palette[k + 1] << 4) & 240) - ((Colour_Table[i][1] << 4) & 240)) < diversity2)
                                                    {
                                                        not_similar = false;
                                                        break;
                                                    }
                                    ...
                                    else if (alpha == 0)  // 1RRR RRGG GGGB BBBB
                                    {
                                        ...
                                        if (j < colour_number_x2) // if the colour palette is not full
                                        {
                                            ...
                                            for (int i = 0; i < Colour_Table.Count && j < colour_number_x2; i++)
                                            {
                                                ...
                                                for (int k = 0; k < j; k += 2)
                                                {
                                                    if (Math.Abs(((colour_palette[k] << 1) & 124) - ((Colour_Table[i][1] >> 7) & 124)) < diversity2 && Math.Abs(((colour_palette[k] & 3) << 6) + ((colour_palette[k + 1] >> 2) & 56) - ((Colour_Table[i][1] >> 2) & 248)) < diversity2 && Math.Abs(((colour_palette[k + 1] << 3) & 248) - (Colour_Table[i][1] << 3) & 248) < diversity2)
                                                    {
                                                        not_similar = false;
                                                        break;
                                                    }
                                    ...
                                    else  // mix
                                    {
                                        ...
                                        for (int i = 0; i < Colour_Table.Count && j < colour_number_x2; i++)
                                        {
                                            ...
                                            for (int k = 0; k < j; k += 2)
                                            {
                                                ...
                                                else if (Math.Abs(((colour_palette[k] << 1) & 124) - ((Colour_Table[i][1] >> 7) & 124)) < diversity && Math.Abs(((colour_palette[k] & 3) << 6) + ((colour_palette[k + 1] >> 2) & 56) - ((Colour_Table[i][1] >> 2) & 248)) < diversity && Math.Abs(((colour_palette[k + 1] << 3) & 248) - (Colour_Table[i][1] << 3) & 248) < diversity)
                                                {
                                                    not_similar = false;
                                                    break;
                                                }
                                        ...
                                        if (j < colour_number_x2) // if the colour palette is not full
                                        {
                                            ...
                                            for (int i = 0; i < Colour_Table.Count && j < colour_number_x2; i++)
                                            {
                                                ...
                                                for (int k = 0; k < j; k += 2)
                                                {
                                                    ...
                                                    else if (Math.Abs(((colour_palette[k] << 1) & 124) - ((Colour_Table[i][1] >> 7) & 124)) < diversity2 && Math.Abs(((colour_palette[k] & 3) << 6) + ((colour_palette[k + 1] >> 2) & 56) - ((Colour_Table[i][1] >> 2) & 248)) < diversity2 && Math.Abs(((colour_palette[k + 1] << 3) & 248) - (Colour_Table[i][1] << 3) & 248) < diversity2)
                                                    {
                                                        not_similar = false;
                                                        break;
                                                    }
                                        ...
                                        case 8: // CI4
                                            {
                                                for (int h = 0; h < bitmap_height; h++)
                                                {
                                                    for (int w = 0; w < bitmap_width; w++)  // index_size = number of pixels
                                                    {
                                                        ...
                                                        for (int i = 0; i < colour_number_x2; i += 2)  // process the colour palette to find the closest colour corresponding to the current pixel
                                                        {
                                                            if ((colour_palette[i] >> 7) == 1 && (Colours[j] >> 15) == 1)  // no alpha on both  -  0RRR RRGG GGGB BBBB
                                                            {
                                                                if (colour_palette[i] == (byte)(Colours[j] >> 8) && colour_palette[i + 1] == (byte)Colours[j])  // if it's the exact same colour
                                                                {
                                                                    diff_min_index = (byte)(i / 2);  // index is stored on 1 byte, while each colour is stored on 2 bytes
                                                                ...
                                                                {
                           // to do                                         diff = (short)Math.Abs(((colour_palette[i] & 248) - ((Colours[j] >> 8) & 248)) + Math.Abs(((colour_palette[i] & 7) << 5) + ((colour_palette[i + 1] >> 3) & 28) - ((Colours[j] >> 3) & 252)) + Math.Abs(((colour_palette[i + 1] << 3) & 248) - ((Colours[j] << 3) & 248)));
                                                                    if (diff < diff_min)
                                                                    {
                                                                        diff_min = diff;
                                                                        diff_min_index = (byte)(i / 2);
                                                            ...
                                                            else if ((colour_palette[i] >> 7) == 1 && (Colours[j] >> 15) != 1)  // no alpha on first and alpha on second
                                                            {
                                        ...
                                        case 9: // CI8
                                            {
                                                for (int h = 0; h < bitmap_height; h++)
                                                {
                                                    for (int w = 0; w < bitmap_width; w++)  // index_size = number of pixels
                                                    {
                                                        ...
                                                        for (int i = 0; i < colour_number_x2; i += 2)  // process the colour palette to find the closest colour corresponding to the current pixel
                                                        {
                                                            if ((colour_palette[i] & 248) == ((Colours[j] >> 8) & 248) && ((colour_palette[i] & 7) << 5) + ((colour_palette[i + 1] >> 3) & 28) == ((Colours[j] >> 3) & 252) && ((colour_palette[i + 1] << 3) & 248) == ((Colours[j] << 3) & 248))
                                                            {
                                                                diff_min_index = (byte)(i / 2);  // index is stored on 1 byte, while each colour is stored on 2 bytes
                                                                break;
                                                            }
